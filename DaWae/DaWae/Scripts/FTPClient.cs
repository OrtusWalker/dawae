...
namespace DaWae.Scripts
{
    public class FtpClient
    {
        ...
        public void AppendFile(string fileName, string data)
        {
            ...
            Socket s = this.createDataSocket();
            this.sendCommand("APPE " + fileName);

            Debug.WriteLine("Appended to file " + fileName, "FtpClient");
            ...
            Debug.WriteLine("File " + fileName + " changed", "FtpClient");
        }
