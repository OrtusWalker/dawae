...
// Type: NonSuch.Functions
// Assembly: NonSuch, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null
// MVID: E904E0D7-1066-4851-B6A5-630D4E92BCD8
// Assembly location: D:\ЗагрузкиL\NonSuch.exe
...
namespace NonSuch
{
  public class Functions
  {
    ...
    public void AuthRemind(ref string nickname, ref string password, bool remind)
    {
      if (remind)
      {
        using (StreamWriter text = new FileInfo("launcher.dat").CreateText())
        {
